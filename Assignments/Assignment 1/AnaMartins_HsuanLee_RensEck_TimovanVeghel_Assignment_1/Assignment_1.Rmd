...
#get.number2 <- function(address){
  #split_x <- strsplit(address, split = " ")
  #non_list <- unlist(split_x)
  #house_number <- non_list[1]
  #return(house_number)
#}
