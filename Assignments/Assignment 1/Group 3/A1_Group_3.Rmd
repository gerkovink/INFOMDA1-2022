...
data%<>% mutate("RiskCat"=case_when(Risk %in% c("AMAN","MAC","CFIT","FUEL",'GTOW',"LOC-I","LOLI","LALT","UIMC")~"Airborne",
Risk %in% c("F-NI","SCF-NP","SCF-PP","SCF")~"Aircraft" ,Risk %in% c("EVAC","F–POST","GCOL","RAMP","LOC–G","RE","RI–A","RI–VAP")~"Ground Operations",
