...
The distribution of number of fatalities was very skewed and consisted of 62% zeros (Table 2),indicating no deaths during the accident. Additionally there was a large proportion (19%) of missing values. Among the fatal accidents  the number of deaths were most frequently between 1 and 25 (Figure 1) with median = 2. However, there are many indiviudal accidents with the number of victims ranging from 25 to 300.
