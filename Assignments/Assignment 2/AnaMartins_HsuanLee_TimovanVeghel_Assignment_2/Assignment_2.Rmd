...
The confusion matrix of the bagging model on the training data shows almost perfect results with accuracy, sensitivity, specificity, PPV and NPV close to 1, again much higher than baseline acuracy. However, it is still not certain if it is a decent model as we do not know whether it is over-fitted or not.
...
imDbRatingVotes <-
  c(790128, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)
metacriticRating <-
  c(96, 64, 67, 74, 60, 86, 81, 89, 65, NA, NA, NA, NA, NA)
runtime <-
  c(132, 129, 161, 106, 138, 151, 139, 117, 117, 190, NA, NA, 128, 188)
year <-
  c(2019,
    2022,
    2022,
...
```{r}
upcoming_pred <- predict(boost_cv, newdata = upcoming)
...
According to our model, none of the "Most Antecipated Movies for 2022" are actually worth watching. The two first movies in there actually came out in the meanwhile, and we can confirm that they do have less than 7.6 at the time of writing this. For the rest of them, 