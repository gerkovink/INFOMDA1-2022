...
Due to the similarity with the bagging method, the random forest has its own internal validation data set from which the accuracy can be tested. Here, we can see that the random forest model has the highest accuracy of 0.9 as 21 features are sampled in each split.
