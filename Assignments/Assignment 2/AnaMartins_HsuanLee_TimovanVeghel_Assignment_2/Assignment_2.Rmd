...
The density plot appeared to be acceptable, with most of the lines following the shape of the observed data (blue).
...
According to our model, two of the "Most Anticipated Movies for 2022" are actually worth watching. They are `The Fabelmans`; and `Pinocchio`. Both films have predictions of over 7.6 and are likely to make it into IMDB's top 1000.