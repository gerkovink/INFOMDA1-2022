...
According to our model, only one of the "Most Anticipated Movies for 2022" is actually worth watching, `Pinocchio`. This means we predict this film will have an IMDb rating of over 7.6 and is likely to make it into IMDB's top 1000. While playing around with the `set.seed()` we sometimes also got that "Black Panther; Wakanda Forever" and "The Fabelmans" would get to the top 1000, so these will also probably be close to making it to a rating of 7.6.