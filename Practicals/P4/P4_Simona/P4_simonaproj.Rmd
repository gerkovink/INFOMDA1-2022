...
12Create a new object called y_pred_95 using predict() (again with the pred_dat data) with the interval argument set to “confidence”. What is in this object?
```{r  }
...
20. Use the function sample() to randomly order this vector and add it to the 
